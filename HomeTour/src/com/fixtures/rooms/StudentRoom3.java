...
public class StudentRoom3 extends Room
{
	...
	public StudentRoom3() {
		super("BedroomC", "A small expensive room", "You are in a small expensive room with a blue mattress that takes up each corner of the room...yeah..welcome to California");
	}	
